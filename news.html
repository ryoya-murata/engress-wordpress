          ...
          <div class="header__contents-wrapper">
             <div class="header__contents">
                ...
                <nav class="header__nav nav is-lg">
                   <ul class="menu">
                      <li class="menu__item"><a href="#" class="menu__link">ホーム</a><!-- /.menu__link --></li><!-- /.menu__item -->
                      <li class="menu__item"><a href="#" class="menu__link">お知らせ</a><!-- /.menu__link --></li><!-- /.menu__item -->
                      <li class="menu__item"><a href="#" class="menu__link">ブログ</a><!-- /.menu__link --></li><!-- /.menu__item -->
                      <li class="menu__item"><a href="#" class="menu__link">コース・料金</a><!-- /.menu__link --></li><!-- /.menu__item -->
                   </ul><!-- /.menu -->
            ...
            <nav class="hamberger-menu is-md">
               ...
               <ul class="menu">
                  <li class="hamberger-menu__item"><a href="#" class="hamberger-menu__link">ホーム</a><!-- /.--></li><!-- /.-->
                  <li class="hamberger-menu__item"><a href="#" class="hamberger-menu__link">お知らせ</a><!-- /.--></li><!-- /.-->
                  <li class="hamberger-menu__item"><a href="#" class="hamberger-menu__link">ブログ</a><!-- /.--></li><!-- /.-->
                  <li class="hamberger-menu__item"><a href="#" class="hamberger-menu__link">コース・料金</a><!-- /.--></li><!-- /.-->
               </ul><!-- /.menu -->
      ...
      <div class="inner inner--middle">
        ...
        <div class="news-archive__contents">
          <div class="news-archive__items news-archive-items">
            <a class="news-archive-item news-archive-items__item">
              <div class="news-archive-item__contents">
                <div class="news-archive-item__time-wrapper">
                  <time class="news-archive-item__time" datetime="2020-12-30">2020-12-30</time><!-- /.news-archive-item__time -->
                </div><!-- /.news-archive-item__time-wrapper -->
                <div class="news-archive-item__title-wrapper">
                  <h3 class="news-archive-item__title">お知らせのタイトルテキストテキストテキストテキストテキストテキストテキスト</h3><!-- /.news-archive-item__title -->
            ...
            <a class="news-archive-item news-archive-items__item">
              <div class="news-archive-item__contents">
                <div class="news-archive-item__time-wrapper">
                  <time class="news-archive-item__time" datetime="2020-12-30">2020-2-30</time><!-- /.news-archive-item__time -->
                </div><!-- /.news-archive-item__time-wrapper -->
                <div class="news-archive-item__title-wrapper">
                  <h3 class="news-archive-item__title">お知らせのタイトルテキストテキストテキストテキストテキストテキストテキストテキストテキスト…</h3><!-- /.news-archive-item__title -->
                </div><!-- /.news-archive-item__title-wrapper -->
              </div><!-- /.news-archive-item_contents -->
            </a><!-- /.news-archive-item news-archive-items__item -->
            <a class="news-archive-item news-archive-items__item">
       ...
       <div class="inner inner--middle">
          <div class="footer__contents">
             <nav class="footer__nav nav">
                   <ul class="menu">
                      <li class="menu__item menu__item--separated"><a href="#" class="menu__link menu__link--footer menu__link--separated">ホーム</a><!-- /.menu__link menu__link--footer menu__link--separated --></li><!-- /.menu__item menu__item--separated -->
                      <li class="menu__item menu__item--separated"><a href="#" class="menu__link menu__link--footer menu__link--separated">お知らせ</a><!-- /.menu__link menu__link--footer menu__link--separated --></li><!-- /.menu__item menu__item--separated -->
                      <li class="menu__item menu__item--separated"><a href="#" class="menu__link menu__link--footer menu__link--separated">ブログ</a><!-- /.menu__link menu__link--footer menu__link--separated --></li><!-- /.menu__item menu__item--separated -->
                      <li class="menu__item menu__item--separated"><a href="#" class="menu__link menu__link--footer menu__link--separated">コース・料金</a><!-- /.menu__link menu__link--footer menu__link--separated --></li><!-- /.menu__item menu__item--separated -->
                   </ul><!-- /.menu -->
                </nav><!-- /.footer__nav nav -->
